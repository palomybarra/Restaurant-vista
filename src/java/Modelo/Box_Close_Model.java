...
public class Box_Close_Model {
    ...
    public Box_Close_Model() {
    }

    public Box_Close_Model(int id_box_close, int amount, Date date_open, Date time_open, int id_box, int id_employee) {
