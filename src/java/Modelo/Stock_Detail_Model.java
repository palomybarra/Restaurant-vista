 ...
 * @author paloma
 */
public class Stock_Detail_Model {
    ...
    public Stock_Detail_Model() {
    }

    
    public Stock_Detail_Model(int id_Stock_Detail, char transaction, int stock_id_stock, int id_location, int id_item) {
