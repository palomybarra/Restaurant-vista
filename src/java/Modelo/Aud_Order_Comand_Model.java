 ...
 * @author paloma
 */
public class Aud_Order_Comand_Model {
    ...
    public Aud_Order_Comand_Model() {
    }

    public Aud_Order_Comand_Model(int id_aud_ordercommand, int id_ordercommand, int id_status_new, int id_status_old, Date date) {
