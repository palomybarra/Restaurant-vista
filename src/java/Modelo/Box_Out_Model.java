...
public class Box_Out_Model {
    ...
    public Box_Out_Model() {
    }

    public Box_Out_Model(int id_box_out, int amount_out, Date date_out, Date time_out, int id_box, int id_payment, int id_employee) {
