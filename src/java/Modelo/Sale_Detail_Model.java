 ...
 * @author paloma
 */
public class Sale_Detail_Model {
    ...
    public Sale_Detail_Model() {
    }

    public Sale_Detail_Model(int id_sale_detail, int id_menu, String plate_description, int id_sale, int id_order_command, int id_sale_type, int id_payment) {
