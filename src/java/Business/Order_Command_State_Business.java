 ...
 * @author paloma
 */
public class Order_Command_State_Business {
    private int id_order_command_state;
    private String description;

    public Order_Command_State_Business() {
    }

    public Order_Command_State_Business(int id_order_command_state, String description) {
