 ...
 * @author paloma
 */
public class Box_Transaction_Business {
    ...
    public Box_Transaction_Business() {
    }

    public Box_Transaction_Business(int id_transaction, int id_box_open, int amount, int id_box, int id_payment, int id_type_transaction) {
