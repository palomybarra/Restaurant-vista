...
public class Sale_Business {
    ...
    public Sale_Business(int id_sale, int net_amount, int tax_amount, int total_amount, Date sale_date, Date time_date, int customer_id_customer, int payment_id_payment) {
